...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-white">
      ...
      <section className="mx-auto flex min-h-screen max-w-6xl flex-col justify-center px-5 pt-24 md:px-6 md:pt-20">
        <p className="mb-4 text-sm uppercase tracking-[0.3em] text-neutral-400">
          Researcher · Developer
        </p>

        <h1 className="max-w-4xl text-5xl font-bold tracking-tight md:text-8xl">
          Yujin Eom
        </h1>

        <p className="mt-6 max-w-2xl text-lg leading-8 text-neutral-300 md:mt-8 md:text-xl">
          Undergraduate researcher interested in Medical AI.
        </p>
      </section>

      <section id="about" className="mx-auto max-w-6xl px-5 py-16 md:px-6 md:py-24">
        ...
        <div className="mt-10 grid items-center gap-10 md:grid-cols-[1fr_240px]">
          <p className="text-lg leading-8 text-neutral-300">
            ...
            University. My research interests lie in Medical
            AI, and Autonomous Driving. Through my research experience at Ajou
            University Hospital, I have worked on medical artificial intelligence
            and healthcare data analysis. I aspire to develop AI technologies
            that create meaningful and positive impacts on people's lives.
          </p>
          ...
          <div className="flex justify-center md:justify-end">
            <Image
              ...
              width={220}
              height={280}
              className="w-44 border border-white/10 object-cover md:w-[220px]"
            />
          </div>
        </div>
      </section>

      <section id="research" className="mx-auto max-w-6xl px-5 py-16 md:px-6 md:py-24">
      ...
      <section id="experience" className="mx-auto max-w-6xl px-5 py-16 md:px-6 md:py-24">
      ...
      <section id="international" className="mx-auto max-w-6xl px-5 py-16 md:px-6 md:py-24">
        <h2 className="text-4xl font-bold">International Programs</h2>

        <div className="mt-10 space-y-6">
          <div>
            <p className="text-neutral-400">April. 2018</p>
            <h3 className="text-xl font-semibold">
      ...
      <section id="awards" className="mx-auto max-w-6xl px-5 py-16 md:px-6 md:py-24">
        ...
        <div className="mt-10 space-y-8">
          ...
          <div>
            ...
            <p className="mt-1 text-neutral-300">Future Researcher Award</p>
          </div>
        </div>
      </section>

      <section id="publications" className="mx-auto max-w-6xl px-5 py-16 md:px-6 md:py-24">
      ...
      <section id="contact" className="mx-auto max-w-6xl px-5 py-16 md:px-6 md:py-24">
